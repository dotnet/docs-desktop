...
- **CodeFile**: System/Windows/Controls/RadioButton.cs
...
| Checked | CheckStates | The control is checked (selected). |
| Unchecked | CheckStates | The control is unchecked (not selected). |
