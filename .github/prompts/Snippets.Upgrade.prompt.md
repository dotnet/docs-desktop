...
```
./snippets/{article-name}/[net-or-framework]/[optional-sub-subject]/{code-language}/
```
...
- `./snippets/clipboard-operations/net/csharp/Form1.cs` (dual-framework, .NET)
- `./snippets/clipboard-operations/framework/csharp/Form1.cs` (dual-framework, .NET Framework)
- `./snippets/program-structure/AsyncProgram/csharp/Program.cs` (clash avoidance)
