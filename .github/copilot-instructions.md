...
Follow the writing style instructions as mentioned in these three articles:
...
Number ordered list items all as "01." instead of "1.", "2.", etc. Use bullets for unordered lists.
