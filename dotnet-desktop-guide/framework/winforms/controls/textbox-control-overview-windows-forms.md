...
description: Learn how the TextBox control is used for editable text and display multiple lines, wrap text to the size of the control and add basic formatting.
---
