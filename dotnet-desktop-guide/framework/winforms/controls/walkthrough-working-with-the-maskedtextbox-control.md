...
description: Learn about and walk through the process of working with the MaskedTextBox control to alert users when the value they're attempting to commit is not valid for the type.  
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
