...
description: Learn how to create a variable sized text in a ComboBox control so that when an item meets a certain criteria, it is drawn in a larger font and turns red.
---
