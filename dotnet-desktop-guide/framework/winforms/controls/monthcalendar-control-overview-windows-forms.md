...
description: This article provides and overview of the MonthCalendar control in Windows Forms, which presents an intuitive GUI for users to view and set date information.
ms.date: "03/30/2017"
f1_keywords: 
  - "MonthCalendar"
helpviewer_keywords: 
