---
title: Walk-through to Populate an Unbound Windows Forms DataGridView Control
...
- Check user input for database-related errors. For more information, see [Walk-through: Handling Errors that Occur During Data Entry in the Windows Forms DataGridView Control](handling-errors-that-occur-during-data-entry-in-the-datagrid.md).
  
- Handle very large data sets using virtual mode. For more information, see [Walk-through: Implementing Virtual Mode in the Windows Forms DataGridView Control](implementing-virtual-mode-wf-datagridview-control.md).
