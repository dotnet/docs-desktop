...
description: Learn about the additional security measures that the .NEfdafdsafdasfadsFramework offers in Windows Forms to restrict access to critical local resources.
ms.date: "03/30/2017"
helpviewer_keywords: 
