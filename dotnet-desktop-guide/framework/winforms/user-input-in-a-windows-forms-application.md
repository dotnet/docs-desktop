...
description: Learn about user input in Windows Forms apps and the keyboard messages that raise events that can be handled to get information about the mouse or keyboard input.
titleSuffix: ""
ms.date: "03/30/2017"
helpviewer_keywords: 
