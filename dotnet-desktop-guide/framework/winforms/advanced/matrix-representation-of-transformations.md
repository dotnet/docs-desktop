...
An m×n matrix is a set of numbers arranged in m rows and n columns. The following illustration shows several matrices.  
 ...
 ![An-illustration-of-matrices.](./media/aboutgdip05-art04.gif "AboutGdip05_art04")  
 ...
 ![An-illustration-of-matrix-addition.](./media/aboutgdip05-art05.gif "AboutGdip05_art05")  
 ...
 ![An-illustration-of-matrix-multiplication.](./media/aboutgdip05-art06.gif "AboutGdip05_art06")  
 ...
 ![An-illustration-of-a-transformation-applied-on-a-point-in-a-plane.](./media/aboutgdip05-art07.gif "AboutGdip05_art07")  
 ...
 ![An-affine-transformation.](./media/aboutgdip05-art08.gif "AboutGdip05_art08")  
 ...
 ![An-affine-transformation-in-a-single-matrix.](./media/aboutgdip05-art09.gif "AboutGdip05_art09")  
 ...
 ![A-linear-transformation-and-a-translation-in-an-affine-transformation.](./media/aboutgdip05-art10.gif "AboutGdip05_art10")  
...
|Matrix C|Translate 3 units in the y direction|  
 ...
 ![A-composite-transformation-in-three-separate-matrices-to-a-single-matrix.](./media/aboutgdip05-art12.gif "AboutGdip05_art12")  
...
> The order of a composite transformation is important. In general, rotate, then scale, then translate is not the same as scale, then rotate, then translate. Similarly, the order of matrix multiplication is important. In general, ABC is not the same as BAC.  
 ...
 ![Building-a-composite-transformation.](./media/aboutgdip05-art13.gif "AboutGdip05_art13")  
