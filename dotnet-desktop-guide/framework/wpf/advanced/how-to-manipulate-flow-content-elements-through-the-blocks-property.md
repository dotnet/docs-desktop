...
description: Shows how to use the Blocks property to manipulate flow content elements
ms.date: "03/30/2017"
dev_langs: 
  - "csharp"
  - "vb"
...
These examples demonstrate some of the more common operations that you can perform on flow content elements through the **Blocks** property. You can use this property to add and remove items from <xref:System.Windows.Documents.BlockCollection>. Flow content elements that feature a **Blocks** property include:  
...
## Example to create a new section and add a new paragraph to the Sections contents
...
## Example to create a new element and insert at the beginning of the Section contents
...
## Example to get the number of top-level elements contained in the Section contents
...
## Example to delete the last element in the Section contents
...
## Example to clear all the content elements in the Section contents
