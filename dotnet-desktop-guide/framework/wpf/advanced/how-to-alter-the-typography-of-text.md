...
description: This guide guides you through altering the typography of text with two examples. The first example shows how typographic properties of text render on screen. the second example shows how you can set typographic property of text programmatically
...
## Example 1: To show how altered and default typographic properties of text render on screen
 ...
 ![Screenshot: Text with default typography](./media/textelement-typog-default.png "TextElement_Typog_Default")
