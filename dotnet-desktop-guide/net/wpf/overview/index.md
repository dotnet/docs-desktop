...
WPF for .NET provides new features and enhancements over .NET Framework. To learn how to upgrade an app, see [How to upgrade a WPF desktop app to .NET 7](../migration/index.md).
