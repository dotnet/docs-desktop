---
title: How to display a common dialog box
...
# How to display a common dialog box (WPF .NET)
...
A message box is another common dialog box. For more information, see [How to use a message box](how-to-display-message-box.md).

## Open File dialog box

The open file dialog box is used by file opening functionality to retrieve the name of a file to open.

:::image type="content" source="media/how-to-display-common-system-dialog-box/open-file-dialog-box.png" alt-text="An Open dialog box showing the location to retrieve the file shown from a WPF application.":::
...
:::code language="csharp" source="snippets/how-to-display-common-system-dialog-box/csharp/Window1.xaml.cs" id="OpenFile":::
:::code language="vb" source="snippets/how-to-display-common-system-dialog-box/vb/Window1.xaml.vb" id="OpenFile":::
...
:::image type="content" source="media/how-to-display-common-system-dialog-box/save-file-dialog-box.png" alt-text="A Save As dialog box showing the location to save the file shown from a WPF application.":::
...
:::code language="csharp" source="snippets/how-to-display-common-system-dialog-box/csharp/Window1.xaml.cs" id="SaveFile":::
:::code language="vb" source="snippets/how-to-display-common-system-dialog-box/vb/Window1.xaml.vb" id="SaveFile":::
...
:::image type="content" source="media/how-to-display-common-system-dialog-box/print-data-dialog-box.png" alt-text="A print dialog box shown from a WPF application.":::
...
:::code language="csharp" source="snippets/how-to-display-common-system-dialog-box/csharp/Window1.xaml.cs" id="Print":::
:::code language="vb" source="snippets/how-to-display-common-system-dialog-box/vb/Window1.xaml.vb" id="Print":::
...
- [Dialog boxes overview (WPF .NET)](dialog-boxes-overview.md)
- [How to use a message box (WPF .NET)](how-to-display-message-box.md)
- [Overview of WPF windows (WPF .NET)](index.md)
