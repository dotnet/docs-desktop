...
:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/App.xaml" id="AppResources":::
...
:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/WindowSingleResource.xaml" id="WindowResources":::
...
:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/Window1.xaml" id="SnippetTextBlocks":::

:::image type="content" source="./media/styles-and-templates-overview/stylingintro-textblocksbefore.png" alt-text="Styling sample screenshot before":::
...
:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/Window1.xaml" id="SnippetDefaultTextBlockStyle":::
...
:::image type="content" source="./media/styles-and-templates-overview/stylingintro-textblocksbasestyle.png" alt-text="Styling sample screenshot base style":::
...
:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/WindowExplicitStyle.xaml" id="ExplicitStyleDeclare":::
...
:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/WindowExplicitStyle.xaml" id="ExplicitStyleReference":::
...
:::image type="content" source="./media/styles-and-templates-overview/create-a-style-explicit-textblock.png" alt-text="Styling sample screenshot textblock":::
...
:::code language="csharp" source="./snippets/how-to-create-apply-template/csharp/Window2.xaml.cs" id="SnippetSetStyleCode":::
:::code language="vb" source="./snippets/how-to-create-apply-template/vb/MainWindow.xaml.vb" id="SnippetSetStyleCode":::
...
:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/Window2.xaml" id="SnippetDefaultTextBlockStyleBasedOn":::

:::code language="xaml" source="./snippets/how-to-create-apply-template/csharp/Window2.xaml" id="SnippetTextBlocksExplicit":::
