...
01. Make the following code changes:
    ...
    01. Before the `class` declaration, import the `System.ComponentModel` namespace, and add the `DefaultEvent` attribute to the class. This attribute sets which event is generated by the consumer when the control is double-clicked in the designer.
