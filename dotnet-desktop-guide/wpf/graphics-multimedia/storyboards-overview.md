...
|--------------------------------|-------------------|-----------|----------------------|-------------------|-------------|
|<xref:System.Windows.Media.Animation.BeginStoryboard> and an <xref:System.Windows.EventTrigger>|[Yes](<xref:System.Windows.FrameworkElement.Triggers>)|Yes|Yes|Yes|[Animate a Property by Using a Storyboard](how-to-animate-a-property-by-using-a-storyboard.md)|
...
|<xref:System.Windows.Media.Animation.Storyboard.Begin%2A> method|[Yes](<xref:System.Windows.FrameworkElement.Triggers>)|No|No|No|[Animate a Property by Using a Storyboard](how-to-animate-a-property-by-using-a-storyboard.md)|
