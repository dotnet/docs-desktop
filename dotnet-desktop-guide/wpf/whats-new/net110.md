---
title: What's new in WPF for .NET 11 RC 1
description: Learn about what's new in Windows Presentation Foundation (WPF) for .NET 11 RC 1. New versions of WPF are released yearly with .NET.
ms.topic: whats-new
ms.date: 09/17/2026
...
# What's new in WPF for .NET 11 RC 1

This article provides a high-level overview of what's new with Windows Presentation Foundation (WPF) in .NET 11 RC 1. For detailed information, see [Release announcements](#release-announcements). Use the release announcements to get an overview of the entire .NET 11 release.
