---
title: What's new in WPF for .NET 11 Preview 3
description: Learn about what's new in Windows Presentation Foundation (WPF) for .NET 11 Preview 3. New versions of WPF are released yearly with .NET.
ms.topic: whats-new
ms.date: 04/10/2026
