...
For more about animating properties, see [Animation overview](../graphics-multimedia/animation-overview.md) and [Storyboards overview](../graphics-multimedia/storyboards-overview.md)
