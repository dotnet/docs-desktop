...
You can either load a file or stream, or you can load an <xref:System.Xml.XmlReader>, <xref:System.IO.TextReader>, or <xref:System.Xaml.XamlReader> that wraps your XAML input by loading with the reader's APIs.
...
- You've defined your own implementation of a <xref:System.Xaml.XamlReader>.
...
The default reader for <xref:System.Xaml.XamlServices> is <xref:System.Xaml.XamlXmlReader>. If you provide your own <xref:System.Xaml.XamlXmlReader> with settings, the following are properties to set non-default <xref:System.Xaml.XamlXmlReaderSettings>:
