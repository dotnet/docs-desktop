...
- [How to: Create Access Keys for Windows Forms Controls](/dotnet/desktop/winforms/controls/how-to-create-access-keys)
- [How to: Set the Text Displayed by a Windows Forms Control](/dotnet/desktop/winforms/controls/how-to-set-the-display-text)
