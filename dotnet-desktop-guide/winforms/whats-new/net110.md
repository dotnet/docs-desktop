...
- <xref:System.Windows.Forms.Clipboard.GetText%2A?displayProperty=nameWithType> with <xref:System.Windows.Forms.TextDataFormat.Rtf?displayProperty=nameWithType> now correctly reads RTF clipboard data that doesn't include a null terminator. This fix resolves an issue where valid RTF content copied from applications such as PowerPoint would return an empty string.
...
- <xref:System.Windows.Forms.PropertyGrid.SelectedTab%2A?displayProperty=nameWithType> now updates correctly when <xref:System.Windows.Forms.PropertyGrid.SelectedObject%2A?displayProperty=nameWithType> is assigned.
